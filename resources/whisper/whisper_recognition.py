...
def get_ffmpeg_path():
    ...
    ffmpeg_names = ("ffmpeg.exe", "ffmpeg") if is_windows else ("ffmpeg", "ffmpeg.exe")
    ...
    for name in ffmpeg_names:
        possible_paths.extend([
            ...
            os.path.join(base_dir, "..", "ffmpeg", name),
            os.path.join(base_dir, "..", "resources", "ffmpeg", name),
        ])
    ...
    for name in ffmpeg_names:
        possible_paths.extend([
            ...
            os.path.join(cwd, "ffmpeg", name),
            os.path.join(cwd, "resources", "ffmpeg", name),
        ])

    # macOS: Homebrew и типичные пути
    ...
    if meipass:
        for name in ffmpeg_names:
            possible_paths.extend([
                ...
                os.path.join(meipass, "ffmpeg", name),
                os.path.join(meipass, "resources", "ffmpeg", name),
            ])
